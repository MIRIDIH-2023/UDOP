...
from src.transformers import (UdopForConditionalGeneration, UdopImageProcessor,
...
def main():
   ...
   # Get datasets
    total_dataset = MIRIDIH_Dataset(processor=processor, tokenizer=tokenizer, data_args=data_args)
